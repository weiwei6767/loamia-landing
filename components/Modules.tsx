...
const modules: Mod[] = [
  ...
  { num: "02", title: "Coast Guard", subtitleKey: "modules.02.subtitle", descKey: "modules.02.desc", span: "lg:col-span-5", bulletKeys: ["modules.02.bullet1", "modules.02.bullet2"] },
            ...
            >
              ...
              {m.feature && (
                <div className="mt-8 pt-6 border-t border-accent-lime/20 space-y-4">
                  <div className="text-xs font-display tracking-widest text-accent-lime/60">{t("modules.example.label")}</div>
                  <div>
                    <div className="text-xs font-display tracking-widest text-ink-100/40 mb-2">{t("modules.example.user.label")}</div>
                    <div className="text-sm text-ink-50/80 leading-relaxed">
                      {t("modules.example.user.body")}
                    </div>
                  </div>
                  <div>
                    <div className="text-xs font-display tracking-widest text-accent-lime/70 mb-2">{t("modules.example.gpt.label")}</div>
                    <div className="text-sm text-ink-50/80 leading-relaxed space-y-2">
                      <p>{t("modules.example.gpt.line1")}</p>
                      <p>{t("modules.example.gpt.line2")}</p>
                      <p>{t("modules.example.gpt.line3")}</p>
                    </div>
                  </div>
                </div>
              )}
