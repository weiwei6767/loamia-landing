      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-ink-100/70 leading-relaxed mb-6">
              廣告代理商的客戶關係具有循環性——客戶可能今年投放、明年暫停、後年又回。傳統工具一旦客戶離開即遺忘所有歷史。
            </p>

            <p className="text-lg text-ink-100/70 leading-relaxed">
          ...
          <div className="lg:col-span-7 relative">
            ...
            <motion.div
              ...
              className="relative p-8 bg-gradient-to-br from-accent-lime/15 to-transparent border border-accent-lime/40 mb-6"
            >
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <div className="font-display font-bold text-3xl">活躍 ACTIVE</div>
                </div>
            ...
            <motion.div
              ...
              className="relative p-8 bg-white/[0.02] border border-white/[0.08]"
            >
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <div className="font-display font-bold text-3xl text-ink-100/80">封存 ARCHIVED</div>
                </div>
                <div className="flex items-center gap-2">
