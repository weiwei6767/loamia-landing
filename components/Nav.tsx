  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <a
          href="#waitlist"
          className="group relative px-5 py-2.5 bg-accent-lime text-ink-950 font-display font-semibold text-sm tracking-wide hover:bg-accent-glow transition-colors"
        >
