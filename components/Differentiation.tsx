      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-12 gap-px bg-white/[0.06] mb-24">
          ...
          {[
            ...
            <div key={i} className="lg:col-span-3 p-6 bg-ink-950">
              <div className="text-xs font-display tracking-widest text-ink-100/40 mb-4">
                {tool.name}
              </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            {
              num: "i.",
              title: "為數位行銷打造的 Brand GPT",
              desc: "拉數據、產報表、發想文案、做 KOL 名單、社群海巡——所有數位行銷的執行動作，都能用自然語言交辦給 Brand GPT。一個平台，等於一整間行銷公司的執行戰力。",
            },
            {
              num: "ii.",
              title: "品牌專屬的大數據資料庫 GPT",
              desc: "自建品牌資料庫成本極高、技術門檻又高。Loamia 直接把跨平台數據、歷史互動、活動成效彙整成你品牌專屬的 AI 資料庫，未來每一次查詢與決策都精準且客製化。",
            },
            {
              num: "iii.",
              title: "越用越懂你的 GPT 行銷助手",
              desc: "隨資料累積，AI 對品牌理解愈深，產出愈精準，形成自我增強飛輪。",
            },
          ].map((d, i) => (
            <motion.div
              key={i}
